...
[最新 Release](https://github.com/yezhihua419-beep/ZenFocus/releases/latest) — 文件名 `ZenFocus-v0.9.3-win-x64.zip`。
...
- 中文买断：[爱发电](https://afdian.com/a/zenfocus) 自定义发电 **69** 元（只付一次）。付完把邮箱发到下面联系方式，我们手发激活码。英文 $19 收银台尚未开通。
